...
summary: Sie können das folgende Skript verwenden, um einen Cluster basierend auf im Skript definierten Parametern und einer JSON-Eingabedatei zu erstellen. 
---
