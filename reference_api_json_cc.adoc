...
summary: Beim Erstellen oder Löschen eines ONTAP Select Clusters mithilfe der Python-Codebeispiele müssen Sie eine JSON-Datei als Eingabe für das Skript bereitstellen. Sie können das entsprechende JSON-Beispiel basierend auf Ihren Bereitstellungsplänen kopieren und ändern. 
---
...
[role="lead"]
Beim Erstellen oder Löschen eines ONTAP Select Clusters mithilfe der Python-Codebeispiele müssen Sie eine JSON-Datei als Eingabe für das Skript bereitstellen. Sie können das entsprechende JSON-Beispiel basierend auf Ihren Bereitstellungsplänen kopieren und ändern.
